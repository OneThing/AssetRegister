...
sqlsrv_query($connection,"UPDATE fields SET 
	field_title = '".$value."',
...
//add new field
if ($_POST['field_add']) {
sqlsrv_query($connection,"INSERT INTO fields (field_title, field_content) VALUES 
	(
		'".insert('field_add')."',
...
<?php if ($totalRows_fields) do { ?>
      <tr>
        ...
        <td nowrap="nowrap" bgcolor="#F4F4F4"><a href="delete.php?field=<?php echo $row_fields['field_id'] . '&ref=' . $row_fields['field_title']; ?>" onclick="javascript:return confirm('Are you sure?')">Delete</a> </td>
      </tr>
