...
<?php $row_count = 1; do { ?>
      <tr <?php if ($row_count%2) { ?>bgcolor="#E9E9E9"<?php } ?>>
        ...
        <td>&nbsp;</td>
        <td><a href="users.php?id=<?php echo $row_users['user_id']; ?>">Edit</a><?php if ($userid != $row_users['user_id']) { ?> | <a onclick="javascript:return confirm('Are you sure?')" href="delete.php?user=<?php echo $row_users['user_id'] . '&ref=' . $row_users['user_name']; ?>">Delete</a><?php } ?></td>
      </tr>
