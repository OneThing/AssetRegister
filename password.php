...
$emailfrom = "admin@apcbackoffice.co.uk";
$name = "APC Financial Customers";
$subject = "Password Reset";
$message = "User " . $row_passwordcheck['user_email'] . " has requested a password reset. ";
$emailto = "admin@apcbackoffice.co.uk";
...
<div class="logincontainer">
  <h1>APC Financial Customers </h1>

    <?php display_msg(); ?>

  <form id="form1" name="form1" method="post" action="">Enter your email address below and Roswell will reset your password and it will be sent to you immediately. <br />
       <br />
